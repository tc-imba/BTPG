...
namespace btpg {
    ...
    public:
        ...
        void SimulateTimeStep(std::vector<int> &movableAgents, std::vector<std::vector<bool>> &visited,
                              std::vector<bool> &finishedAgent);
        void SimulateTPGTimeStep(std::vector<int> &movableAgents, std::vector<std::vector<bool>> &visited,
                                 std::vector<bool> &finishedAgent);
        void SimulateTPGWoDelayTimeStep(std::vector<int> &movableAgents, std::vector<std::vector<bool>> &visited,
                                        std::vector<bool> &finishedAgent);

        int moveRotation(std::vector<std::pair<std::pair<int, int>, std::pair<int, int>>> &BTPGrotationStopRobots_,
                         std::vector<int> &movableAgents, std::vector<std::vector<bool>> &visited,
                         std::vector<bool> &finishedAgent, int &NumRobotsCanMoveBasedOnBTPG,
                         std::vector<int> &tempCheckMoveAgents);
        int moveTPGRotation(std::vector<std::pair<std::pair<int, int>, std::pair<int, int>>> &BTPGrotationStopRobots_,
                            std::vector<int> &movableAgents, std::vector<std::vector<bool>> &visited,
                            std::vector<bool> &finishedAgent, int &NumRobotsCanMoveBasedOnBTPG,
                            std::vector<int> &tempCheckMoveAgents);
        int
        moveTPGWoDelayRotation(std::vector<std::pair<std::pair<int, int>, std::pair<int, int>>> &TPGrotationStopRobots_,
                               std::vector<int> &movableAgents, std::vector<std::vector<bool>> &visited,
                               std::vector<bool> &finishedAgent, int &NumRobotsCanMoveBasedOnTPG,
                               std::vector<int> &tempCheckMoveAgents);
